...
<body class="bg-gray-50">
    ...
    <nav class="bg-white border-b border-gray-200 px-6 py-3 flex justify-between items-center shadow-sm">
        ...
        <div class="flex items-center gap-6">
            <a href="{{ route('teacher.dashboard') }}" class="text-gray-700 hover:text-indigo-600 font-medium">Home</a>
            <a href="#" class="text-gray-700 hover:text-indigo-600 font-medium">Request</a>
            <a href="#" class="text-gray-700 hover:text-indigo-600 font-medium">Earn</a>
            ...
            <div class="relative">
                <button onclick="toggleDropdown()" class="flex items-center focus:outline-none">
                    ...
                    <span class="ml-2 font-medium text-gray-700">{{ Auth::user()->name ?? 'Teacher' }}</span>
                </button>
