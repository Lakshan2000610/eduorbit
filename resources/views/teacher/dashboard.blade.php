...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-gray-600 mt-1">Here's what's happening with your teaching today</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-xs text-gray-500 mt-2">Teaching offerings</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <p class="text-xs text-gray-500 mt-2">New student requests</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2">Rs. </p>
                </div>
                <div class="w-12 h-12 bg-yellow-100 rounded-lg flex items-center justify-center">
                    <svg class="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                </div>
            </div>
            <p class="text-xs text-gray-500 mt-2">December 2025</p>
        </div>
    </div>

    <!-- You can add Upcoming Sessions, Recent Messages, Notifications sections here later -->
